...
const CACHE=`${CACHE_PREFIX}v1.13.0`;
const LEGACY_CACHES=SCOPE_TAG==='beta'?['energo-prehled-v1.1.0']:['energo-prehled-v1.0.0'];
const ASSETS=['./','./index.html','./styles.css?v=1.13.0','./core/model.js?v=1.13.0','./core/time.js?v=1.13.0','./core/forecast.js?v=1.13.0','./core/regime.js?v=1.13.0','./core/power.js?v=1.13.0','./core/report.js?v=1.13.0','./core/finance-analytics.js?v=1.13.0','./core/invoice.js?v=1.13.0','./core/invoice-parser.js?v=1.13.0','./app.js?v=1.13.0','./manifest.webmanifest','../icons/icon-180.png','../icons/icon-192.png','../icons/icon-512.png'];
