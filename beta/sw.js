...
const ASSETS=['./','./index.html','./styles.css?v=1.6.0','./core/model.js?v=1.6.0','./core/time.js?v=1.6.0','./core/forecast.js?v=1.6.0','./core/invoice.js?v=1.6.0','./app.js?v=1.6.0','./manifest.webmanifest','../icons/icon-180.png','../icons/icon-192.png','../icons/icon-512.png'];
