...
const CACHE=`${CACHE_PREFIX}v1.5.13`;
const LEGACY_CACHES=SCOPE_TAG==='beta'?['energo-prehled-v1.1.0']:['energo-prehled-v1.0.0'];
const ASSETS=['./','./index.html','./styles.css?v=1.5.13','./app.js?v=1.5.13','./manifest.webmanifest','../icons/icon-180.png','../icons/icon-192.png','../icons/icon-512.png'];
