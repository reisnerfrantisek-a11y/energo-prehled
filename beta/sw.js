...
const CACHE=`${CACHE_PREFIX}v1.6.2`;
const LEGACY_CACHES=SCOPE_TAG==='beta'?['energo-prehled-v1.1.0']:['energo-prehled-v1.0.0'];
const ASSETS=['./','./index.html','./styles.css?v=1.6.2','./core/model.js?v=1.6.2','./core/time.js?v=1.6.2','./core/forecast.js?v=1.6.2','./core/invoice.js?v=1.6.2','./core/invoice-parser.js?v=1.6.2','./app.js?v=1.6.2','./manifest.webmanifest','../icons/icon-180.png','../icons/icon-192.png','../icons/icon-512.png'];
...
self.addEventListener('fetch',e=>{
  ...
  const networkFirst=e.request.mode==='navigate'||/\/(?:app\.js|styles\.css|manifest\.webmanifest)$/.test(url.pathname);
  if(networkFirst){
