...
const ASSETS=['./','./index.html','./styles.css?v=1.7.2','./core/model.js?v=1.7.2','./core/time.js?v=1.7.2','./core/forecast.js?v=1.7.2','./core/invoice.js?v=1.7.2','./core/invoice-parser.js?v=1.7.2','./app.js?v=1.7.2','./manifest.webmanifest','../icons/icon-180.png','../icons/icon-192.png','../icons/icon-512.png'];
