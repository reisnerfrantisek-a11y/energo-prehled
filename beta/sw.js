...
const ASSETS=['./','./index.html','./styles.css?v=1.6.1','./core/model.js?v=1.6.1','./core/time.js?v=1.6.1','./core/forecast.js?v=1.6.1','./core/invoice.js?v=1.6.1','./core/invoice-parser.js?v=1.6.1','./app.js?v=1.6.1','./manifest.webmanifest','../icons/icon-180.png','../icons/icon-192.png','../icons/icon-512.png'];
